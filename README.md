...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("GhostshHit") or v.Name == ("SwordGhostsh") or v.Name == ("GhostshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "Ghost Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Ghost Hub"})
